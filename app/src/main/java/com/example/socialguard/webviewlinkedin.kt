...
class webviewlinkedin : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            setContentView(R.layout.activity_webviewlinkedin)
        ...
        inner class JavaScriptInterface {
            ...
            fun identifyMedia() {
                runOnUiThread {
                    AlertDialog.Builder(this@webviewlinkedin)
                        .setTitle("Processing")
                        .setMessage("Identifying media from LinkedIn...")
