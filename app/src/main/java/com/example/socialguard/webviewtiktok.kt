...
class webviewtiktok : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            setContentView(R.layout.activity_webviewtiktok)
        ...
        inner class JavaScriptInterface {
            ...
            fun identifyMedia() {
                runOnUiThread {
                    AlertDialog.Builder(this@webviewtiktok)
                        .setTitle("Processing")
                        .setMessage("Identifying media from TikTok...")
